      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <input
            ...
            className="w-full mb-4 p-2 rounded border border-gray-300 dark:border-gray-700 bg-gray-100 dark:bg-gray-700"
          />
          <textarea
          ...
          <button
            type="submit"
            className="w-full py-2 bg-purple-500 hover:bg-purple-600 text-white font-semibold rounded-md transition"
          >
            Créer
          </button>
